 ...
 * cluster application. This implementation relies on JeroMQ for communication.
 */
public class JmqClientEndpoint extends AbstractJmqEndpoint {
     ...
     */
    public JmqClientEndpoint(String hostAddress, int hostPort, int port, MessageHandlerFactory messageHandlerFactory) {
